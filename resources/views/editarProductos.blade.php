...
<form action="/admin/producto/{{$producto->id}}" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="inputName" value="{{$producto->nombre}}">
    </div>

  <div class="col-md-6 mb-3">
    <strong><label for="exampleFormControlTextarea1">Descripción</label></strong>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5">{{$producto->descripcion}}</textarea>
  </div>

  <div class="form-group col-md-4">
    <strong><label for="precio">Precio</label></strong>
    <input type="number" class="form-control" id="precio" step="1" value="{{$producto->precio}}">
  </div>
    ...
    <div class="form-group col-md-12">
      ...
      <select class="custom-select" id="categoria_id">
